/*
  ...
  - You are about to drop the column `isUninstalled` on the `Session` table. All the data in the column will be lost.
  - You are about to drop the column `reinstalledAt` on the `Session` table. All the data in the column will be lost.
  - You are about to drop the column `uninstalledAt` on the `Session` table. All the data in the column will be lost.
